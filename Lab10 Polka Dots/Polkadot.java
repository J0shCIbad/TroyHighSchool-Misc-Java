import java.awt.*;
/**
 * A Polkadot contains a set of coordinates, size, and color, to draw
 * a circle of specified size and color in the specified location,
 * onto the buffer graphics
 * @author Josh Ibad
 * @author James Park
 * @version 10/30/2017
 * @period 2
...
public class Polkadot
{
    ...
    // constructors
    /** 
     *  Constructs a Polkadot with the coordinates (200, 200), with a
     *  diameter of 25, with the color Red.
     **/
    public Polkadot()
    {
        myX = 200;
    ...
    /** 
     *  Constructs a Polkadot with the coordinates (x,y), with a diameter
     *  of d, with the Color c.
     *  
